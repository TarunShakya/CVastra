...
const Interview = () => {
    ...
    const { report, error, getReportById, loading, getResumePdf } = useInterview()
    const { interviewId } = useParams()

    // Note: useInterview already fetches the report on mount via its own
    // useEffect (keyed on interviewId from useParams), so this effect is
    // redundant and has been removed to avoid a duplicate fetch.
